import { KeybindingCommand, KeybindingRule, KeybindingsConfig } from "@fatma/contracts";
    ...
    Layer.provideMerge(
      Layer.effect(
        ...
        Effect.gen(function* () {
          ...
          const dir = yield* fs.makeTempDirectoryScoped({ prefix: "fatma-server-config-test-" });
