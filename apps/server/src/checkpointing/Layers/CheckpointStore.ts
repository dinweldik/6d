  ...
  const captureCheckpoint: CheckpointStoreShape["captureCheckpoint"] = (input) =>
    Effect.gen(function* () {
      ...
      yield* Effect.acquireUseRelease(
        fs.makeTempDirectory({ prefix: "fatma-fs-checkpoint-" }),
        (tempDir) =>
          Effect.gen(function* () {
            ...
            const commitEnv: NodeJS.ProcessEnv = {
              ...
              GIT_AUTHOR_NAME: "fatma",
              GIT_AUTHOR_EMAIL: "fatma@users.noreply.github.com",
              GIT_COMMITTER_NAME: "fatma",
              GIT_COMMITTER_EMAIL: "fatma@users.noreply.github.com",
            };
            ...
            const message = `fatma checkpoint ref=${input.checkpointRef}`;
